...
const credentials = {
  ...
  redirect_uris: ["https://huebye.github.io/meet/"],
  javascript_origins: ["https://huebye.github.io", "http://localhost:3000","*","http://192.168.1.6:8080"],
};
...
module.exports.getAccessToken = async (event) => {
  ...
  module.exports.getCalendarEvents = async (event) => {
    ...
    .then((results) => {
      //responds with result of calendar events!
